...
public class FullscreenAdapter extends FragmentPagerAdapter {
    ...
    public FullscreenAdapter(Context context, FragmentManager fm, Cursor cursor) {
        super(fm);
        init(context, cursor);
    }
    ...
    public Fragment getItem(int position) {
        Log.d("MATS", "getItem="+position);
        if (mDataValid) {
            mCursor.moveToPosition(position);
            return new FullscreenSlideFragment(mCursor);
        } else {
            return null;
        }
    }
